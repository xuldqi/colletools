              ...
              <div key={index} className="border border-gray-200 rounded-lg p-6">
                <div className="flex items-center mb-4">
                  <span className={`px-3 py-1 rounded text-sm font-medium mr-3 ${
                    endpoint.method === 'POST' ? 'bg-green-100 text-green-800' : 'bg-primary-100 text-primary-800'
                  }`}>
                    {endpoint.method}
                  </span>
...
?>`}
        ...
        <div className="bg-primary-50 rounded-lg p-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              to="/help"
              className="inline-flex items-center justify-center px-6 py-3 bg-white text-primary-600 font-medium rounded-lg border border-primary-600 hover:bg-primary-50 transition-colors"
            >
              查看帮助文档
            </Link>
          </div>
