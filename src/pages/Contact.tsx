            ...
            <div className="bg-white rounded-lg shadow-sm p-8">
              ...
              <div className="mt-8 pt-8 border-t border-gray-200">
                ...
                <div className="space-y-2">
                  <Link to="/help" className="block text-primary-600 hover:text-primary-700 transition-colors">
                    {t('contact.quickLinks.helpCenter')}
                  </Link>
                  <Link to="/api-docs" className="block text-primary-600 hover:text-primary-700 transition-colors">
                    {t('contact.quickLinks.apiDocs')}
                  </Link>
                  <Link to="/privacy" className="block text-primary-600 hover:text-primary-700 transition-colors">
                    {t('contact.quickLinks.privacy')}
                  </Link>
                  <Link to="/terms" className="block text-primary-600 hover:text-primary-700 transition-colors">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-lg shadow-sm p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full md:w-auto inline-flex items-center justify-center px-8 py-3 bg-primary-600 text-white font-medium rounded-lg hover:bg-primary-700 focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 transition-colors"
                >
