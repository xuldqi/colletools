                    ...
                    {section.links.map((link, linkIndex) => (
                      ...
                      >
                        <div className="flex items-start">
                          ...
                          <ArrowLeft className="w-4 h-4 text-gray-400 group-hover:text-primary-600 transform rotate-180 transition-colors" />
                        </div>
                      </Link>
                    ))}
                  </div>
