...
import { Upload, FileText, Camera, CreditCard, Car, Receipt, Scan, ArrowLeft } from 'lucide-react';
...
const OCRTools: React.FC = () => {
  ...
  if (selectedTool) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-primary-50 py-12">
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center space-x-4">
                <div className="flex items-center justify-center w-12 h-12 bg-primary-100 rounded-lg">
                  <selectedTool.icon className="w-6 h-6 text-primary-600" />
                </div>
                <div>
                  ...
                  <p className="text-sm text-primary-600">{t('common.supportedLanguages')}: {selectedTool.languages}</p>
                </div>
              </div>
              <button
                onClick={resetTool}
                ...
                >
                  <div className="flex items-center mb-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-primary-600">{tool.languages}</p>
                    </div>
                  </div>
