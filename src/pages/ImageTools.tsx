                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    {selectedTool.id === 'image-compressor' && estimatedSizeMB && (
                      <p className="text-sm text-primary-600 mt-1">{t('common.estimatedSize')}: ~{estimatedSizeMB}MB（{t('common.estimated')}）</p>
                    )}
                  </div>
                  {processedImageUrl && (
                    <div>
    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <PageHero
          ...
          subtitle={t('tools.image.pageDescription')}
          icon={Image}
          iconBgClassName="bg-green-100"
          iconTextClassName="text-green-700"
        />
