    ...
    <div className="max-w-xl mx-auto py-10 px-4">
      ...
      <Card>
        <div className="flex gap-2 mb-6">
          <input className="flex-grow p-2 border rounded" placeholder="Add option (e.g. Taco Bell)" value={newOption} onChange={(e) => setNewOption(e.target.value)} onKeyDown={(e) => e.key === 'Enter' && addOption()} />
